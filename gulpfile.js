...
const _CONFIG = (
    {
        ...
        EntrypointInputSourceFile: `${__dirname}/source/DataArithmatic-Browser-Shim.js`,
        ...
        LibraryObjectName: `DataArithmatic`,
        ...
        LibraryUniminifiedFileName: `dataarithmatic.js`,

        // The name of the minified version of the packaged library, for production release:
        LibraryMinifiedFileName: `dataarithmatic.min.js`
    });
